...
public class IntakeCoralWithAlgae extends Command {
  ...
  public IntakeCoralWithAlgae(StateMachine subStateMachine, Hopper subHopper, CoralOuttake subCoralOuttake,
  ...
  public void initialize() {
    ...
    globalLED.setLEDSolid(constLED.LED_INTAKE_CORAL_HOPPER);
