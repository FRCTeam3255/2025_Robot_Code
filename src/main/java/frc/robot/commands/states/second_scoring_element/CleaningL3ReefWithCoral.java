...
public class CleaningL3ReefWithCoral extends Command {
  StateMachine globalStateMachine;
  Elevator globalElevator;
  AlgaeIntake globalAlgaeIntake;
  LED globalLED;

  public CleaningL3ReefWithCoral(StateMachine subStateMachine, Elevator subElevator, AlgaeIntake subAlgaeIntake,
      LED subLED) {
  ...
  public void initialize() {
    ...
    globalStateMachine.setRobotState(RobotState.CLEANING_L3_WITH_CORAL);
    ...
    globalLED.setLEDSolid(constLED.LED_CLEANING_L3_REEF);
  }
