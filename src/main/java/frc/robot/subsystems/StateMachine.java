    ...
    switch (desiredState) {
      ...
      case PREP_CORAL_L1:
        switch (currentRobotState) {
          ...
          case PREP_CORAL_L4:
          case PREP_CORAL_ZERO:
            return new PrepCoralLv(subStateMachine, subCoralOuttake, subElevator, subAlgaeIntake,
                constElevator.CORAL_L1_HEIGHT, subLED);
        }
        break;
      ...
      case PREP_CORAL_L2:
        switch (currentRobotState) {
          ...
          case PREP_CORAL_ZERO:
            return new PrepCoralLv(subStateMachine, subCoralOuttake, subElevator, subAlgaeIntake,
                constElevator.CORAL_L2_HEIGHT, subLED);
        }
        break;
      ...
      case PREP_CORAL_L3:
        switch (currentRobotState) {
          ...
          case PREP_CORAL_ZERO:
            return new PrepCoralLv(subStateMachine, subCoralOuttake, subElevator, subAlgaeIntake,
                constElevator.CORAL_L3_HEIGHT, subLED);
        }
        break;
      ...
      case PREP_CORAL_L4:
        switch (currentRobotState) {
          ...
          case PREP_CORAL_ZERO:
            return new PrepCoralLv(subStateMachine, subCoralOuttake, subElevator, subAlgaeIntake,
                constElevator.CORAL_L4_HEIGHT, subLED);
        }
        break;
      ...
      case PREP_CORAL_ZERO:
        switch (currentRobotState) {
          ...
          case PREP_CORAL_L4:
          case HAS_CORAL:
            return new PrepCoralZero(subStateMachine, subCoralOuttake, subElevator, subLED);
        }
        break;
      ...
      case PREP_CORAL_L1_WITH_ALGAE:
        switch (currentRobotState) {
          ...
          case PREP_ALGAE_ZERO_WITH_CORAL:
            return new PrepCoralLvWithAlgae(subStateMachine, subCoralOuttake, subElevator,
                constElevator.CORAL_L1_HEIGHT, subLED,
                subAlgaeIntake);
        }
        break;
      ...
      case PREP_CORAL_ZERO_WITH_ALGAE:
        switch (currentRobotState) {
          ...
          case PREP_NET_WITH_CORAL:
          case PREP_ALGAE_ZERO_WITH_CORAL:
            return new PrepCoralZeroWithAlgae(subStateMachine, subCoralOuttake, subElevator, subLED);
        }
        break;
