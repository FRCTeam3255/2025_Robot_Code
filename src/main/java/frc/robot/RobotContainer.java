...
public class RobotContainer {
  ...
  private void configureTesterBindings(SN_XboxController controller) {
    ...
    controller.btn_Y.whileTrue(subElevator.sysIdQuasistatic(SysIdRoutine.Direction.kForward));
    controller.btn_A.whileTrue(subElevator.sysIdQuasistatic(SysIdRoutine.Direction.kReverse));
